...
namespace backend.Controllers
{
    ...
    public class DataBaseLayerController : ControllerBase
    {
        ...
        public IList<FileModel> GetFilteredList(string filterParameters)
        {
            ...
            if ((userDetails[0] == "ALL") && (userDetails[1] == emptyVersion || userDetails[1] == "") && (userDetails[2] == "ALL"))
            {
                Console.WriteLine("command 1 is :", CommandText);
                CommandText = CommandText;
            }
            else if ((userDetails[0] == "ALL") && (userDetails[1] == emptyVersion || userDetails[1] == "") && (userDetails[2] != "ALL"))
            {
